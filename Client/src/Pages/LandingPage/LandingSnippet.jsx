...
const LandingSnippet = () => {
  return (
    <section className="flex items-center justify-center px-4 py-16 sm:px-6 sm:py-24">
      <div className="w-full max-w-5xl rounded-xl border border-[#232733]  overflow-hidden shadow-2xl shadow-black/40">
        ...
        <div className="p-4 sm:p-8">
          ...
          <div className="flex flex-col gap-3.5">
            {snippets.map((snippet) => (
              <div
                key={snippet.title}
                className="rounded-[10px] border border-[#232733] bg-[#171B24] hover:bg-[#1C2029] hover:border-[#2D3241] p-4 transition-colors sm:p-5"
              >
